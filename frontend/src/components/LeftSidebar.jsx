...
export const LeftSidebar = () => {
  ...
  return (
    /* w-[240px] — hidden below lg, then shows as fixed-width column */
    <aside
      className="sticky top-20 hidden h-fit w-[240px] shrink-0 flex-col gap-1 lg:flex"
    ...
    >
      ...
      {NAV_SHORTCUTS.map((s) => (
        ...
        >
          <img src={s.avatar} alt={s.name} className="h-9 w-9 shrink-0 rounded-xl object-cover" />
